...
import leadsConectarMetaHandler from "../api/leads/conectar-meta.js";
import leadsDesconectarMetaHandler from "../api/leads/desconectar-meta.js";
import leadsMetaCampanhasMensagemHandler from "../api/leads/meta-campanhas-mensagem.js";
import leadsMetaContasAnuncioHandler from "../api/leads/meta-contas-anuncio.js";
...
post("/api/leads/conectar-meta", leadsConectarMetaHandler);
post("/api/leads/desconectar-meta", leadsDesconectarMetaHandler);
get("/api/leads/meta-contas-anuncio", leadsMetaContasAnuncioHandler);
get("/api/leads/meta-campanhas-mensagem", leadsMetaCampanhasMensagemHandler);
